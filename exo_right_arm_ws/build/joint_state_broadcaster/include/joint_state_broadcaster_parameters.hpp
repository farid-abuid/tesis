...
[[nodiscard]] auto to_parameter_value(rsl::StaticVector<T, capacity> const& value) {
    ...
    struct Params {
        ...
        bool publish_dynamic_joint_states = false;
  ...
  public:
    ...
    void declare_params(){
      ...
      if (!parameters_interface_->has_parameter(prefix_ + "publish_dynamic_joint_states")) {
          rcl_interfaces::msg::ParameterDescriptor descriptor;
          descriptor.description = "[Deprecated] Whether to publish dynamic joint states. This parameter is deprecated and will be removed in future releases.";
          descriptor.read_only = true;
